<?php
    ...
    if(isset($_POST['submit_anadir_convenio'])){  
        ...
        } else if ($pais=="Marruecos") { $continente=1;} else if ($pais=="Mauricio") { $continente=1;} else if ($pais=="Mauritania") { $continente=1;} else if ($pais=="Micronesia") { $continente=5;} else if ($pais=="Moldavia") { $continente=4;
