...
<html lang="en">
  <head>
    ...
    <!--CSS-->
    <link href="css_mensajes/mensaje3.css" rel="stylesheet" >
    <!--JS-->
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-5">
                        <div class="dbox dbox--color-1">
                            ...
                            <span class="dbox__count">SE AÑADIÓ CORRECTAMENTE ESTA UNIVERSIDAD/INSTITUTO CON LOS CONVENIOS CORRESPONDIENTES</span>
                            <span class="dbox__title">YA LO PUEDES VER EN LAS DIFERENTES SECCIONES</span>
                        </div>
