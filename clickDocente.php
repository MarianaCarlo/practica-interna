...
$query2 = "INSERT INTO reportesambos(codigo,ocupacion,campus,ciudad,nombre_universidad,pais,fecha,hora) VALUES('$docente','$ocupacion','$campus','$ciudad','$nombre_u', '$pais', curDate(),curTime());";
